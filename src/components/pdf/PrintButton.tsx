...
export default function PrintButton(props: Props) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-slate-800 text-slate-200 hover:bg-slate-700 active:scale-95 transition-all duration-150 disabled:opacity-50"
    >
